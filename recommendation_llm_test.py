...
def get_portfolio_recommendation(row: pd.Series, portfolio: Dict[str, Any]) -> pd.Series:
    ...
    prompt = f"""
You are a senior investment strategist advising a client with the following portfolio.
Your task is to provide a single, consolidated action recommendation based on the news summary and the provided industry risk scores (1-10, where 10 is highest risk).
